...
def parse_config():
    ...
    parser.add_argument('--max_waiting_mins', type=int, default=15, help='max waiting minutes')
    parser.add_argument('--start_epoch', type=int, default=25, help='')
