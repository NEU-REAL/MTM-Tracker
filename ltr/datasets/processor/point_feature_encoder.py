...
# get points features according to x, y, z, r
    ...
    def forward(self, data_dict):
        ...
        Returns:
            data_dict:
                ...
                ...
        """
        data_dict['template_points'], use_lead_xyz = getattr(self, self.point_encoding_config.encoding_type)(
            data_dict['template_points']
        )

        data_dict['search_points'], use_lead_xyz = getattr(self, self.point_encoding_config.encoding_type)(
            data_dict['search_points']
        )
